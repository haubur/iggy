...
pub struct IggyConsumerConfig {
    /// Name of the stream. Must be unique. The consumer binds to the stream by this name.
    stream_name: String,
    /// Name of the topic. Must be unique. The consumer binds to the topic by this name.
    topic_name: String,
